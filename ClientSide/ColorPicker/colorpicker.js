$(function(){
	...
	var init = function(){
		...
		HSL_L.mousedown(function(e){
			down = true;
			console.log(e.clientY, HSL_L.get(0).offsetTop, $(".ui-dialog").get(0).offsetTop);
			var distance = e.clientY - (HSL_L.get(0).offsetTop + 32 + $(".ui-dialog").get(0).offsetTop); //32 is width of dialog title
