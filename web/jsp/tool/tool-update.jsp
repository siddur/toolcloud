...
<script>
	...
	$(document).ready(function(){
		inputDiv = $($("div.input div.unit")[0]).clone();
		outputDiv = $($("div.output div.unit")[0]).clone();
		//$(":text").addClass("txt");
	});
...
<body>
	...
	<div class="body attr-item-container">
		<form method="post" action="/toolcloud/ctrl/tool/save" >
			...
			<br/>
			<s:file_upload fieldname="icon" displayname="upload image.." isImg="true" url="${td.icon}"/>
			<div>
			...
			<div class="input">
				...
				<input type="button" value="add one more" class="btn" onclick="add(0)">
			...
			<div class="output">
				...
				<input type="button" value="add one more" class="btn" onclick="add(1)">
			...
			<center><input type="submit" class="btn" value="save"></center>		
		</form>
	</div>
</body>